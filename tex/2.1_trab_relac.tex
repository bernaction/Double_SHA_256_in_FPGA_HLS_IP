...
\begin{figure}[H]
    ...
    \includegraphics[width=0.55\linewidth]{trabalhos//img/kammoun_execution.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.55\linewidth]{trabalhos//img/kammoun_energy.png}
    \caption*{Fonte: \cite{kammoun2020}.}
