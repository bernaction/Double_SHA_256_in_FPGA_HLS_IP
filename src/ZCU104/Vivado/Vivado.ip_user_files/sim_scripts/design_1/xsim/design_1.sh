...
#
# Script generated by Vivado on Tue Jun 10 15:51:40 -0300 2025
...
export RDI_DATADIR="B:/Xilinx/Vivado/2024.2/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="B:/Xilinx/Vivado/2024.2/data/xsim"
  fi
