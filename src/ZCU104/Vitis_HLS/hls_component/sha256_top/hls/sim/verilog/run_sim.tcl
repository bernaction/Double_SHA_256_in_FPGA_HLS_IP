...
if {[file isfile sha256_top.autotvin.dat]} {
	file delete -force sha256_top.autotvin.dat
}

if {[file isfile sha256_top.autotvout.dat]} {
	file delete -force sha256_top.autotvout.dat
}
