...
AUTOPILOT_ROOT := B:/Xilinx/Vitis/2024.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := B:/Xilinx/Vitis/2024.2/tps/win64/msys64/mingw64/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := B:/Xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --sysroot=B:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
LFLAG += --sysroot=B:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
LFLAG += -lpthread
LFLAG += -L B:/Xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/windows -lclang_rt.builtins-x86_64
...
$(ObjDir)/sha256_test.c_pre.c.tb.o : sha256_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sha256_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sha256_top.c_pre.c.tb.o : sha256_top.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sha256_top.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/sha256.c_pre.c.tb.o : sha256.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sha256.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
