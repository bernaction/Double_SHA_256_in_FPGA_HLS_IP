set moduleName sha256_top_Pipeline_1
set isTopModule 0
...
set cdfgNum 12
set C_modelName {sha256_top_Pipeline_1}
...
set C_modelArgList {
	{ state int 32 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "state", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 3 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 32 } } }
}
