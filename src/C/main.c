...
int main() {
  const char *header_hex =
    "0100000050120119172a610421a6c3011dd330d9df07b63616c2cc1f1cd0"
    "0200000000006657a9252aacd5c0b2940996ecff952228c3067cc38d4885"
    "efb5a4ac4247e9f337221b4d4c86041b0f2b5710"; // Header com nonce
  ...
  printf("--------- TESTE DOUBLE SHA256 - CPU (AMD Ryzen 7 5800x3D arch:amd64) ---------\n\n\n");
